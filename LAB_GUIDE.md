...
Nó chạy, trả lời request, và bạn chỉ biết có chuyện khi nhìn hóa đơn. Không mặc định = lỗi hiện ra lúc deploy, khi bạn còn đang nhìn màn hình. pydantic-settings tự ánh xạ tên trường sang biến môi trường viết hoa:
